...
public class Normal_Bidder extends Agent {
...
class receiveProposal extends CyclicBehaviour {
    ...
    private Normal_Bidder testAgent;

    public receiveProposal(Normal_Bidder agent) {
        super(agent);
        testAgent = agent;
    }
    ...
    public void action() {
        ...
        if (msg != null) {
            ...
            testAgent.belief=(int)(testbelief*0.95);
...
class Winner extends CyclicBehaviour {
    ...
    public Winner(Normal_Bidder agent) {
        super(agent);
        testAgent = agent;
    }
...
class Inform extends CyclicBehaviour {
	 private Normal_Bidder testAgent;
	    ...
	    public Inform(Normal_Bidder agent) {
	        super(agent);
	        testAgent = agent;
	    }
    public void action() {
